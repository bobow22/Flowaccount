...
export default function Cash_invoice() {
  ...
  useEffect(() => {
    ...
    //Discount
    setDiscount(
      parseFloat(sum) - parseFloat(sum) * parseFloat(numberdiscount / 100)
    ); //Discount
    ...
    setTax(
      parseFloat(sum) -
        (parseFloat(sum) * parseFloat(numberdiscount / 100) * 7) / 100
    ); //Tax

    //Net Total
    setNetTotal(
      parseFloat(sum) -
        parseFloat(sum) * parseFloat(numberdiscount / 100) +
        parseFloat(sum) -
        parseFloat(sum) * parseFloat(numberdiscount / 100)
    ); //Discount
  }, [
      ...
      <div className="Content">
        <div className="Btn_and_PDF">
          <div className="Btn_Content">
            ...
            <button type="submit" className="button-2" onClick={postApi}>
              บันทึก
            </button>
            <button type="submit" className="button-2" onClick={postApi}>
              รับ PDF
              ...
              >
                <div>
                  <p>
                    ...
                    <input
                      type="text"
                      placeholder="ตัวอย่าง บริษัท ขายดี จำกัด"
                    />
                    <span>
                      <br />
                      ชื่อ:{" "}
              ...
              >
                <p>
                  ...
                  <span>
                    ...
                    <input
                      type="text"
                      placeholder="ตัวอย่าง นาย รักดี รักมั่น"
                    />
                  </span>
                  <span>
                    <br />
              ...
              <div className="summary" style={{ fontSize: "13px" }}>
                <p>
                  ...
                  <span className="result4">
                    <td>
                      <p type="float" placeholder="101.65">
                        {netTotal
                          .toFixed(2)
                          .toString()
                          .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
